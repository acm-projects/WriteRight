    ...
    <div className="bgBlue">
        ...
        <br></br>
            <div class='row1WT'>
                ...
                <button className="postWT"><img src={idk} className="imageWT" alt="idk" />hi??<br></br><span className="articleWT">some other text</span></button>
                </a>
                &nbsp;
                &nbsp;
                &nbsp;
            ...
            <br></br>
                <a href="https://github.com/acm-projects/WriteRight#readme">
                <button className="postWT"><img src={idk} className="imageWT" alt="idk" />row 2<br></br><span className="articleWT">some other text</span></button>
                </a>
            </div>
