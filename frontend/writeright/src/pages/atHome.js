...
function AtHome() {
  ...
  let {mc1, hh1, mc2, hh2, mc3, hh3, mc4, hh4, mc5, hh5, 
    mc6, hh6, mc7, hh7, mc8, hh8, mc9, hh9} = atHomeData;
  ...
  const handleSubmit = (e) => {
    ...
    const userData = {
        mc1, hh1, mc2, hh2, mc3, hh3, mc4, hh4, mc5, hh5, 
    mc6, hh6, mc7, hh7, mc8, hh8, mc9, hh9
    };
    ...
    <div className="bgRedWhite">
        ...
        <div class='parentAH'>
                <table class="atHome">
                    ...
                    <tr>
                        <td><p className="questionsCL">How do they create conflict for each other?</p></td>
                        <td><textarea
                            rows = "2"
                            required
                            type="mc1"
                    ...
                    <tr>
                        <td><p className="questionsCL">What annoys them about each other?</p></td>
                        <td><textarea
                            rows = "2"
                            required
                            type="mc2"
                    ...
                    <tr>
                        <td><p className="questionsCL">What do they need to allow each other to do?</p></td>
                        <td><textarea
                            rows = "2"
                            required
                            type="mc3"
                    ...
                    <tr>
                        <td><p className="questionsCL">What do they need to prohibit each other from doing?</p></td>
                        <td><textarea
                            rows = "2"
                            required
                            type="mc4"
                    ...
                    <tr>
                        <td><p className="questionsCL">What do they need to hide from each other?</p></td>
                        <td><textarea
                            rows = "2"
                            required
                            type="mc5"
                    ...
                    <tr>
                        <td><p className="questionsCL">How did they come to share a dwelling?</p></td>
                        <td><textarea
                            rows = "2"
                            required
                            type="mc6"
                    ...
                    <tr>
                        <td><p className="questionsCL">What are their household responsibilities?</p></td>
                        <td><textarea
                            rows = "2"
                            required
                            type="mc7"
                    ...
                    <tr>
                        <td><p className="questionsCL">What do they contribute to the household?</p></td>
                        <td><textarea
                            rows = "2"
                            required
                            type="mc8"
                    ...
                    <tr>
                        <td><p className="questionsCL">What keeps them living together, despite the conflicts?</p></td>
                        <td><textarea
                            rows = "2"
                            required
                            type="mc9"
